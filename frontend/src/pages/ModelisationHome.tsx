...
// ─── NavDropdown (mirroring Layout.tsx form, olive theme) ─────────────────────
    ...
    <div className="relative group flex-shrink-0" style={{ isolation: 'auto' }}>
      <button
        ...
        style={
          isGroupActive
            ? {
                background: 'hsla(83,50%,55%,0.18)',
                borderColor: 'hsla(83,50%,55%,0.40)',
              }
            : undefined
        }
        onMouseEnter={e => {
          if (!isGroupActive) e.currentTarget.style.background = 'hsla(0,0%,100%,0.07)'
        }}
        onMouseLeave={e => {
          if (!isGroupActive) e.currentTarget.style.background = ''
        }}
      >
        <Icon
          size={14}
      ...
      {/* Dropdown panel */}
      <div
        className="absolute left-0 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200"
        style={{
          top: 'calc(100% + 8px)',
          zIndex: 200,
          background: 'hsla(83,30%,12%,0.96)',
          backdropFilter: 'blur(20px)',
          WebkitBackdropFilter: 'blur(20px)',
          border: '1px solid hsla(83,52%,50%,0.25)',
          boxShadow: '0 16px 48px hsla(83,40%,8%,0.55)',
          borderRadius: 12,
          minWidth: 220,
          padding: 6,
        }}
      >
        {children.map(({ label: childLabel, icon: ChildIcon }) => (
          ...
          >
            ...
            <span
              className="ml-auto px-1.5 py-0.5 rounded text-[8px] font-bold uppercase tracking-wider"
              style={{
                background: 'hsla(83,52%,50%,0.15)',
                color: 'hsl(83,60%,70%)',
                border: '1px solid hsla(83,52%,50%,0.25)',
              }}
            >
...
export default function ModelisationHome() {
  ...
  return (
    ...
    >
      {/* ─────────────────────────────────────────────────────
          TOP NAVBAR — same form as Layout.tsx, olive theme
          ───────────────────────────────────────────────────── */}
      <header
        ...
        style={{
          height: 64,
          background:
            'linear-gradient(135deg, hsl(83,40%,10%) 0%, hsl(83,38%,16%) 40%, hsl(83,42%,22%) 70%, hsl(100,36%,18%) 100%)',
      ...
      >
        ...
        <div
          ...
          style={{
            background:
              'linear-gradient(90deg, transparent 5%, hsla(83,60%,70%,0.40) 30%, hsla(0,0%,100%,0.12) 50%, hsla(83,60%,70%,0.40) 70%, transparent 95%)',
          }}
        />
        ...
        <div
          ...
          style={{
            background:
              'linear-gradient(90deg, transparent 0%, hsl(83,54%,32%) 15%, hsl(83,52%,42%) 40%, hsl(83,55%,52%) 55%, hsl(83,52%,42%) 70%, hsl(83,54%,32%) 85%, transparent 100%)',
          }}
        />
        ...
        >
          <div
            className="w-9 h-9 rounded-lg flex items-center justify-center text-[10px] font-extrabold text-white flex-shrink-0 tracking-wider"
            style={{
              background:
                'linear-gradient(135deg, hsl(83,54%,30%) 0%, hsl(83,52%,42%) 60%, hsl(83,55%,55%) 100%)',
              boxShadow:
                '0 2px 12px hsla(83,55%,50%,0.55), inset 0 1px 0 hsla(0,0%,100%,0.20)',
            }}
          >
            SCAR
          </div>
          <div className="flex flex-col justify-center">
            ...
            <span
              className="text-[0.59rem] font-medium tracking-[0.18em] uppercase mt-px"
          ...
          {navItems.map(item =>
            item.children ? (
              ...
              <button
                ...
                onMouseEnter={e => {
                  if (pathname !== item.to && item.to === '/modelisation')
                    e.currentTarget.style.background = 'hsla(0,0%,100%,0.07)'
                }}
                onMouseLeave={e => {
                  if (pathname !== item.to)
        ...
        >
          ...
          >
            ...
            <span
              className="hidden xl:block text-[0.6rem] mt-0.5 tracking-wide"
              style={{ color: 'hsla(0,0%,100%,0.40)' }}
            >
              En intégration
            </span>
          ...
          <button
            ...
            style={{
              background:
                'linear-gradient(135deg, hsl(83,54%,30%) 0%, hsl(83,52%,42%) 55%, hsl(83,55%,52%) 100%)',
              boxShadow:
                '0 2px 12px hsla(83,55%,50%,0.45), inset 0 1px 0 hsla(0,0%,100%,0.18)',
              border: 'none',
            }}
            onMouseEnter={e => {
              e.currentTarget.style.transform = 'translateY(-2px)'
              e.currentTarget.style.boxShadow =
                '0 4px 20px hsla(83,55%,50%,0.55), inset 0 1px 0 hsla(0,0%,100%,0.22)'
            }}
            onMouseLeave={e => {
