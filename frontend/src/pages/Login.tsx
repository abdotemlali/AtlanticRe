      ...
      >
        ...
        <div className="flex flex-col items-center mb-8">
          ...
          <div className="text-center">
            <span className="text-[1.6rem] font-extrabold tracking-tight" style={{ color: 'hsl(209,28%,20%)' }}>
              Atlantic<span style={{ color: 'hsl(83,52%,36%)' }}>Re</span>
            </span>
            <p className="text-[0.62rem] font-bold tracking-[0.22em] uppercase mt-0.5" style={{ color: 'hsl(218,10%,55%)' }}>
              CDG GROUP
            </p>
          </div>
        </div>
        ...
        <div className="mb-6 pb-4" style={{ borderBottom: '1.5px solid hsl(218,22%,93%)' }}>
          <h1 className="text-lg font-bold" style={{ color: 'hsl(209,28%,20%)' }}>
            Connexion
          </h1>
          <div className="flex items-center gap-1.5 mt-1.5">
            <Shield size={13} style={{ color: 'hsl(83,52%,36%)' }} />
            <span className="text-xs font-medium" style={{ color: 'hsl(218,10%,55%)' }}>
              Accès sécurisé — Plateforme Decision Intelligence
            </span>
          </div>
        </div>
        ...
        >
          <p className="text-[0.62rem] font-bold uppercase tracking-widest mb-2.5" style={{ color: 'hsl(218,10%,65%)' }}>
            Comptes de test
          </p>
          <div className="space-y-1.5 text-xs" style={{ color: 'hsl(218,12%,42%)' }}>
            <div className="flex justify-between items-center">
              <span>Administrateur</span>
              <span
                className="font-mono px-2 py-0.5 rounded text-navy"
                style={{ background: 'hsl(218,22%,93%)' }}
              >
                admin / admin123
              </span>
            </div>
