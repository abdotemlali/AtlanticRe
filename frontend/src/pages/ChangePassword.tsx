        ...
        >
            ...
            >
                ...
                <div className="mb-6 border-b border-[#EEF0F3] pb-4 text-center">
                    <h1 className="text-xl font-bold" style={{ color: '#2D3E50' }}>Définir votre mot de passe</h1>
                    <div className="flex justify-center items-center gap-2 mt-2">
                        <Shield size={14} color="#6B8C2A" />
                        <span className="text-xs font-medium" style={{ color: '#7A8A99' }}>Première connexion</span>
                    </div>
                </div>

                <div className="bg-[#FFF8E7] border-l-[3px] border-[#F4C842] py-2 px-3 rounded text-[0.75rem] mb-5" style={{ color: '#B07D00' }}>
