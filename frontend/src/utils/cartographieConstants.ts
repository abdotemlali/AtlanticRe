...
export const NUMERIC_TO_ISO3: Record<number, string> = {
  ...
  // Sahara Occidental → traité comme Maroc (même couleur et données)
  732: 'MAR',
}
...
export const AFRICA_NUMERIC = new Set([
  ...
  480, 504, 508, 516, 562, 566, 646, 686, 694, 706, 710, 716, 724, 728, 729, 732,
  736, 748, 768, 788, 800, 818, 834, 894,
])
