# Présentation Portail360 — Atlantic Re (TargetBD)
## La version hybride : Design Canva + Discours Stratégique DG

Ce document fusionne la structure visuelle (pour la conception sur Canva) avec les arguments métiers percutants et le "Speech pour le Directeur Général" développés précédemment. Il intègre toutes les fonctionnalités clés (Imputation, Matching Flou, What-If, etc.).
...
| Élément | Couleur | Hex |
|---------|---------|-----|
| Navy (fond principal) | Bleu marine profond | `#2D3E50` |
| Olive (accent principal) | Vert olive | `#4E6820` |
| Olive clair (highlights) | Vert clair | `#A8C45A` |
| Or / Gold (synergie) | Or profond | `#C48C14` |
| Fond slides | Gris très clair | `#F7F8FA` |
| Typographie | Inter ou Outfit | Google Fonts |

---

## SLIDE 1 — Page de Garde & Accroche Stratégique

**🎨 Visuel (Canva) :** 
**Fond :** Dégradé diagonal `#1B2A3A` → `#2D3E50` avec une grille fine en overlay.
**Badge haut :** `CDG Group · TargetBD`
**Titre :** Digitalisation de l'Expansion Africaine
**Sous-titre :** De la donnée brute à la décision stratégique (Plan Reach2030)
**Bandeau bas :** `60+ Marchés | 400+ Cédantes | 34 Pays | 10 Ans de données`

**🗣️ Speech (Pour le DG) :**
> "Bonjour à tous, bonjour Monsieur le Directeur Général. Nous vous présentons aujourd'hui l'aboutissement de notre projet : la plateforme 'Portail360'. Ce n'est pas qu'une simple démonstration technique, c'est l'outil stratégique conçu pour soutenir sur le terrain votre ambition d'expansion, et transformer la donnée brute en une véritable certitude d'investissement pour le plan Reach2030."
...
**Schéma :** 4 blocs numérotés verticalement (timeline style) avec icône et couleur.
1. 🔧 **Pipeline ETL** (Gris)
2. 📋 **Portefeuille Interne - Axe 1** (Navy)
3. 🌍 **Modélisation Afrique - Axe 2 & Croisement** (Olive)
4. 🤖 **Machine Learning & Scoring** (Or)

**🗣️ Speech :**
> "Voici comment nous allons vous dévoiler cet écosystème aujourd'hui :
> 1. D'abord, notre 'Usine à Données' : la rationalisation du Marché Externe.
> 2. Ensuite, notre Plateforme Interne : l'audit et la maîtrise de notre propre portefeuille.
> 3. Puis, l'étape décisive : le croisement de l'interne et de l'externe pour révéler notre Exposition Relative.
> 4. Et enfin, le Moteur d'Intelligence Artificielle chargé du classement des marchés."

---

## SLIDE 3 — Contexte & Défi Métier (Avant / Après)

**🎨 Visuel (Canva) :** 
**Titre :** 🌍 Contexte : Pourquoi disrupter notre approche ?
**Schéma :** Colonne de gauche (Avant : collectes manuelles, lenteur, subjectivité). Colonne de droite (La vision TargetBD : 215% S2, ROE 13,4% $\rightarrow$ Exigence de proactivité objective).

**🗣️ Speech :**
> "Notre immersion avec le Pôle Business Développement a révélé un goulot d'étranglement. Pour évaluer un marché cible pour Atlantic Re, l'équipe collectait manuellement des données éparpillées (Axco, Banque Mondiale, FANAF). Le croisement avec notre historique interne (parfois mal orthographié dans SAP) était un travail laborieux. 
> Portail360 répond à cette urgence : il remplace une approche 'artisanale et dispersée' par un modèle de Gouvernance Unifiée."
...
**🗣️ Speech (Focus Fonctionnalité DG) :**
> "Les données africaines officielles sont souvent incomplètes. Au lieu de rejeter un marché potentiel par manque d'une seule année statistique, notre plateforme s'appuie sur l'**Imputation Intelligente**. Le système comble les trous statistiquement en regardant la dynamique régionale, et y appose un tag 'Estimé' pour que le décideur connaisse toujours le niveau exact de fiabilité de sa donnée. La base est prête et saine."
...
**🗣️ Speech (Focus Fonctionnalité DG) :**
> "Nous maîtrisons aussi nos cessions sortantes. Outre la gestion des sécurités de Traités, nous avons créé le module **FAC-to-FAC**. Cet outil scanne l'ensemble de notre portefeuille et isole nos partenaires à 'Double Rôle' — ceux qui nous cèdent des affaires mais à qui nous rétrocédons aussi du risque. Vous savez désormais exactement qui offre le vrai bilan net positif à l'entreprise."
...
**🗣️ Speech (Focus Fonctionnalité DG) :**
> "Voici le point central de notre intelligence de marché : l'**Exposition Relative**. Nous superposons nos données internes au marché externe pour voir notre 'Pénétration réelle'. Sommes-nous déjà saturés dans ce pays ? Ou bien notre part de marché n'est-elle que de 2%, laissant à Reach2030 toute la place pour de la conquête commerciale à profit ?"
...
**🗣️ Speech (Focus Fonctionnalité DG) :**
> "Mais l'IA ne décide pas à votre place, elle vous obéit. La fonctionnalité reine pour le comité de direction est la **Matrice 'What-If'**. Si une crise régulatoire frappe le continent demain, vous ajustez, en glissant un curseur depuis la plateforme, le poids du 'Risque Politique'. Le modèle recalcule en temps réel tous ses scores et modifie instantanément les recommandations des pays : qui bascule 'À Éviter' et qui demeure 'Attractif'. Le pilotage de la stratégie est total."
...
**🗣️ Speech :**
> "Pour Atlantic Re, nous passons avec ce PFE du concept à l'infrastructure industrielle. En l'espace de ce projet, nous livrons : 
> 1. Une Usine de centralisation data automatisée unique au sein du groupe.
...
**🗣️ Speech :**
> "Ce socle est infiniment 'scalable' (évolutif). Ce que nous avons codé pour l'expansion Africaine peut intégrer demain les marchés Asiatiques avec les mêmes pipelines. Mieux encore : ce classement pays prédictif pourra un jour s'interfacer directement avec les logiciels de souscription pour ajuster la tarification d'un contrat en fonction du risque du marché. 
> Atlantic Re dispose aujourd'hui d'une vigie digitale pour son avenir. Merci beaucoup pour votre attention, nous sommes à disposition pour vos questions et/ou une démo en direct de l'outil."
